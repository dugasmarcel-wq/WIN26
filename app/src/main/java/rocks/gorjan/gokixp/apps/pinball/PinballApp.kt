 ...
 *
 * Modeled on the Internet Explorer WebView configuration, and on the same app-class
 * pattern the other programs use: a plain controller that takes an inflated content view
 * via [setupApp] and releases resources in [cleanup]. The game and all of its assets live under
